    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (Object(muka_lib_isNumber__WEBPACK_IMPORTED_MODULE_3__["default"])(selected) && selected !== nextProps.selected) {
        ...
        var time = setTimeout(function () {
          console.log(selected, '23333333333');

          _this3.setState({
            selectIndex: selected
          }, function () {
            if (_this3.animateNode) {
              _this3.animateNode.addEventListener('transitionend', _this3.handleAnimate);
...
//# sourceMappingURL=5.9481c2ae96469ec604e0.hot-update.js.map
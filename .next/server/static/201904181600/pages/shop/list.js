...
module.exports = __webpack_require__("ZZnt");
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SET_SHOPLIST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return actions; });
var SET_SHOPLIST = 'SET_SHOPLIST';
var actions = {
  setShopList: function setShopList(data) {
    return {
      type: SET_SHOPLIST,
      data: data
    };
...
module.exports = {
	"page_navbar": "page_navbar___2Nrb7"
};
...
// EXTERNAL MODULE: ./components/lib/Table/style/index.ts
var Table_style = __webpack_require__("CZFz");

// EXTERNAL MODULE: ./components/lib/Table/index.tsx
var Table = __webpack_require__("Og9s");
...
// EXTERNAL MODULE: external "antd/lib/notification/style"
var style_ = __webpack_require__("3tNq");
...
var global = __webpack_require__("Qemm");

// EXTERNAL MODULE: ./store/action/shop/shopList.ts
var shop_shopList = __webpack_require__("9bWv");

// CONCATENATED MODULE: ./store/action/shop/index.ts

// EXTERNAL MODULE: ./pages/shop/index.less
var shop = __webpack_require__("mX/2");

// EXTERNAL MODULE: ./node_modules/next/link.js
var next_link = __webpack_require__("YFqc");
var link_default = /*#__PURE__*/__webpack_require__.n(next_link);

// CONCATENATED MODULE: ./pages/shop/list.tsx
...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(ShopList, _Component);
  ...
  function ShopList() {
    ...
    Object(classCallCheck["a" /* default */])(this, ShopList);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(ShopList)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "getItems", function (exFun) {
      _this.exFun = exFun;
      var item = [{
        field: 'id',
        component: 'NULL'
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "columns", [{
      title: '店铺Logo',
      dataIndex: 'shopLogo',
      key: 'shopLogo',
      render: function render() {
        ...
        return external_react_default.a.createElement(Image["a" /* default */], {
          src: axios["a" /* baseUrl */] + data.shopLogo,
          className: shop["shop_logo"]
        });
      }
    }, {
      title: '店铺名',
      ...
      render: function render(val) {
        return _this.getStatusLable(val);
      }
    }, {
      title: '操作',
      dataIndex: 'id',
      ...
      render: function render(val) {
        return external_react_default.a.createElement(link_default.a, {
          ...
          prefetch: true
        }, external_react_default.a.createElement(Label["default"], null, "\u8FDB\u5165\u5E97\u94FA"));
      }
    }]);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleDialogClose", function () {
      _this.setState({
        visible: false
      });
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleDialogOk",
    /*#__PURE__*/
    Object(asyncToGenerator["a" /* default */])(
    /*#__PURE__*/
    regenerator_default.a.mark(function _callee() {
      var _data, formData, params, res, _this$props, shopList, setShopList;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _data = _this.exFun.getFieldValue(); // if (notVal(data.startDeliveryMoney) || notVal(data.riderDeliveryMoney) || notVal(data.name) || notVal(data.averageMoney) || !data.address.address) {
              ...
              _data.shopLogo.map(function (i) {
                formData.append('avatar', i.file);
              });

              params = '?';

              keys_default()(Object(omit["a" /* default */])(_data, ['shopLogo', 'address'])).map(function (i) {
                params += i + '=' + _data[i] + '&';
              });

              params += 'address=' + _data['address'].address + '&';
              params += 'addressComponents=' + stringify_default()(_data['address'].addressComponents) + '&';
              params += 'location=' + stringify_default()(_data['address'].location);
              _context.prev = 9;
              _context.next = 12;
              return Object(axios["c" /* default */])("shop/create".concat(params), formData, {
                headers: {
            ...
            case 12:
              res = _context.sent;
              _this$props = _this.props, shopList = _this$props.shopList, setShopList = _this$props.setShopList;
              setShopList([res.data].concat(Object(toConsumableArray["a" /* default */])(shopList)));
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleShowDialog", function () {
      _this.setState({
        visible: true
      });
    });
  ...
  Object(createClass["a" /* default */])(ShopList, [{
    key: "render",
    value: function render() {
      var shopList = this.props.shopList;
      var visible = this.state.visible;
      var navBar = external_react_default.a.createElement(NavBar["a" /* default */], {
        className: global["page_navbar"],
        title: external_react_default.a.createElement(LabelHeader["a" /* default */], {
          title: "\u6211\u7684\u5E97\u94FA",
          line: "vertical"
        }),
      ...
      return external_react_default.a.createElement(PageHead["a" /* default */], {
        ...
        navBar: navBar
      }, external_react_default.a.createElement(Table["a" /* default */], {
      ...
      }, external_react_default.a.createElement(LForm["a" /* default */], {
        getItems: this.getItems
      }))));
    }
  }, {
    key: "getStatusLable",
    value: function getStatusLable(status) {
      switch (status) {
        case 1:
          {
            return external_react_default.a.createElement(Label["default"], {
              color: "green"
            }, "\u5BA1\u6838\u4E2D");
          }
        ...
        default:
          return external_react_default.a.createElement(Label["default"], null);
      }
    }
  }], [{
    key: "getInitialProps",
        ...
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Object(axios["g" /* initServerData */])(ctx);
              ...
              case 5:
                _context2.next = 7;
                return Object(axios["c" /* default */])('shop/find', {}, {
                  headers: {
                    cookie: ctx.req && ctx.req.headers.cookie
                  }
                });
              ...
              case 7:
                ...
                ctx.store.dispatch({
                  type: shop_shopList["a" /* SET_SHOPLIST */],
                  data: shopList.data
                });
                return _context2.abrupt("return", {});
...
/* harmony default export */ var list = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(function (state) {
  return {
    shopList: state.shopList
  };
}, function (dispatch) {
  return Object(external_redux_["bindActionCreators"])(shop_shopList["b" /* actions */], dispatch);
})(list_ShopList));

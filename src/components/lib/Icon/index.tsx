...
const paths: any = {
    ...
    'alipay': import('./global/alipay').then((data) => data.default),
    'book-mark': import('./global/book-mark').then((data) => data.default),
    'file': import('./global/file').then((data) => data.default),
    'fire': import('./global/fire').then((data) => data.default),
    'trophy': import('./global/trophy').then((data) => data.default),
}
